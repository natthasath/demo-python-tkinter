...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("CustomTkinter Template GUI")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Template GUI", image=self.logo_image, compound="left", font=customtkinter.CTkFont(size=15, weight="bold"))
